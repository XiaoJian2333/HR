...
<script type="text/javascript">
	...
	function openStaffCheckDialog(){
		...
		if(row.state=="已删除"){
			$.messager.alert("系统提示","请选择一条待复核或正常状态的数据！");
			return;
		}
		...
		url="staff?add=3&id="+row.id+"&state=2";
	}
</script>
</head>
<body style="margin: 5px;">
	...
	<table id="dg" title="员工信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="staff?add=4" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openStaffCheckDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">复核</a>
		</div>
	</div>
	...
	<div id="dlg-buttons">
		<a href="javascript:saveStaff()" class="easyui-linkbutton" iconCls="icon-ok" id="save">复核</a>
